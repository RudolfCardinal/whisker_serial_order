...
htmlhelp_basename = 'whisker_serial_orderdoc'
...
man_pages = [
    (master_doc, 'whisker_serial_order', 'whisker_serial_order Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'whisker_serial_order', 'whisker_serial_order Documentation',
     author, 'whisker_serial_order', 'One line description of project.',
     'Miscellaneous'),
]
